...
def language_input() -> int:
    ...
    """
    lang_choice = int(input('Enter a language key: '))
    return lang_choice
...
def greet(name: str, greetings_options: Dict[int, str], lang_choice: int) -> None:
    ...
    :return:
    """
    a = greetings_options[lang_choice][rand_num] + ' ' + name
    print(a)
...
if __name__ == '__main__':
    ...
    if mode_choice == 1:
        condi = True
        while condi:
            #print(f'{get_mode(mode_choice)} mode selected')
            ...
            if action_choice == 1:
                ...
                if lang_update_choice in lang_dict.keys():
                    ...
                    print(f'{lang_update_choice1} has been udpated to {lang_update_choice2}')
                    print_lang_only(lang_dict)
